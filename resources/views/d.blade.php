...
<head>
    ...
    <script src="./Dashboard Template · Bootstrap v5.3_files/color-modes.js.download"></script>
    <link href="{{ asset('d/bootstrap.min.css') }}" rel="stylesheet"
    ...
    <link href="{{ asset('d/dashboard.css') }}" rel="stylesheet">
    <style>
        .bd-placeholder-img {
            font-size: 1.125rem;
            text-anchor: middle;
...
<body> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle"> <button
        ...
        <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="bd-theme-text">
            ...
            <li> <button type="button" class="dropdown-item d-flex align-items-center active"
                    data-bs-theme-value="dark" aria-pressed="true"> <svg class="bi me-2 opacity-50" aria-hidden="true">
                        <use href="#moon-stars-fill"></use>
                    </svg>
                    Dark
                    <svg class="bi ms-auto d-none" aria-hidden="true">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2 active"
                                    aria-current="page" href="https://getbootstrap.com/docs/5.3/examples/dashboard/#">
                            ...
                            <li class="nav-item"> <a class="nav-link d-flex align-items-center gap-2"
                                    href="https://getbootstrap.com/docs/5.3/examples/dashboard/#"> <svg class="bi"
                                        aria-hidden="true">
                        ...
                        <h6
                            ...
                            <span>Saved reports</span> <a class="link-secondary"
    ...
    <script src="./Dashboard Template · Bootstrap v5.3_files/bootstrap.bundle.min.js.download"
        integrity="sha384-j1CDi7MgGQ12Z7Qab0qlWQ/Qqz24Gc6BM0thvEMVjHnfYGF0rmFCozFSxQBxwHKO" class="astro-vvvwv3sm"></script>
    <script src="./Dashboard Template · Bootstrap v5.3_files/chart.umd.js.download"
        integrity="sha384-eI7PSr3L1XLISH8JdDII5YN/njoSsxfbrkCTnJrzXt+ENP5MOVBxD+l6sEG4zoLp" crossorigin="anonymous"
        class="astro-vvvwv3sm"></script>
    <script src="./Dashboard Template · Bootstrap v5.3_files/dashboard.js.download" class="astro-vvvwv3sm"></script>
</body>
